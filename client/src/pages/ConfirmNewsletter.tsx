...
export default function ConfirmNewsletter() {
  ...
  useEffect(() => {
    ...
    confirm.mutateAsync({ token })
      .then(() => { setStatus("ok"); })
      .catch((e) => { setStatus("error"); setMessage(e?.message || "Lien invalide ou expiré."); });
        ...
        <CardContent className="space-y-4 text-center">
          ...
          {status === "ok" && (
            <div className="flex flex-col items-center gap-2 py-8">
              ...
              <p className="font-medium">Votre inscription est confirmée !</p>
              <p className="text-sm text-muted-foreground">Vous recevrez désormais notre newsletter.</p>
          ...
          {status === "error" && (
            <div className="flex flex-col items-center gap-2 py-8">
              ...
              <p className="font-medium">Échec de la confirmation</p>
