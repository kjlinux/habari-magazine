...
const sampleArticles = [
  ...
  { id: 9, rubrique: "La Grande Interview", title: "Loïc Mackosso : \u00ab Rester debout, c'est décider de se renforcer \u00bb", excerpt: "Banquier d'affaires et fondateur d'Aries Investissements, Loïc Mackosso livre un témoignage puissant sur la résilience, l'entrepreneuriat en Afrique et la reconstruction après la guerre civile au Congo.", slug: "interview-mackosso-rester-debout", date: "Février 2026", country: "Congo", access: "free", image: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663347570863/ARoCDHZWpDwKcVeV.jpg" },
                      ...
                      <Card className={`group cursor-pointer border-0 shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden h-full ${article.access === "premium" ? "opacity-90" : ""}`}>
                        <div className="w-full h-52 bg-gradient-to-br from-primary/10 to-primary/5 relative overflow-hidden">
                          {(article as any).image ? (
                            <img src={(article as any).image} alt={article.title} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
